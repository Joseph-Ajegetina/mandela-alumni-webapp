...
import { IRegister, IRegisterMessage, IRegisterSubmit } from '../interfaces/register';
...
export class ServiceService {
  ...
  registerUser(userData: IRegister):Observable<IRegisterMessage> {
   ...
   return this.http.post<IRegisterMessage>(`${environment.API_URL}/auth/register`, transformedUserData);
  }
